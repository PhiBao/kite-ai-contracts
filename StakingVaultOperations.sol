...
contract StakingVaultOperations is IStakingVaultOperations {
    ...
    /// @notice Role constant for operator management (add/remove operators, update allocations)
    bytes32 public constant OPERATOR_MANAGER_ROLE = StakingVaultStorageLib.OPERATOR_MANAGER_ROLE;

    /// @notice Role constant for vault administration (fees, unpause, force-removal)
    bytes32 public constant VAULT_ADMIN_ROLE = StakingVaultStorageLib.VAULT_ADMIN_ROLE;

    /// @notice Role constant for emergency pause
    bytes32 public constant GUARDIAN_ROLE = StakingVaultStorageLib.GUARDIAN_ROLE;
